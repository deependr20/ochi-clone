...
const Eyes = () => {
  ...
  return (
    <div data-scroll data-scroll-speed="-.4" data-scroll-section className=" w-full h-screen overflow-hidden ">
      <div className="w-full relative h-full bg-cover bg-center bg-[url('https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-scaled.jpg')]">
        <div className="absolute  flex gap-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          {/* First Eye */}
          <div className="bg-white md:w-[15vw]  w-[25vw] h-[25vw] md:h-[15vw] flex items-center justify-center rounded-full">
            <div className="bg-black flex items-center rounded-full justify-center h-[60%] w-[60%]">
              ...
              >
                <div className="bg-white rounded-full h-5 w-5 md:h-7 md:w-7"></div>
              </div>
            </div>
          </div>
          {/* Second Eye */}
