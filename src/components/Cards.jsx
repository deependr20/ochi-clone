...
const Cards = () => {
  ...
  return (
    <div  className='md:px-12 px-5 w-full h-[160vh] relative md:h-[80vh] py-16 bg-[#F1F1F1] flex md:flex-row flex-col  gap-5 justify-between  border-zinc-400'>
         <div className='lg:w-1/2 w-full md:h-[60vh] h-[90vh]  bg-[#004D43] rounded-lg  flex justify-center items-center'>
         ...
         <div className='lg:w-1/2 w-full flex md:h-[60vh]  h-[90vh] md:flex-row flex-col gap-5  justify-between'>
             ...
             <div className='lg:w-1/2 w-full  h-[45vh] md:h-full  bg-[#212121] rounded-lg flex justify-center items-center'>
                 ...
                 <button onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className={`text-white md:text-base text-xs hover-target bg-[#212121] border   border-slate-400 px-2 py-1 rounded-full absolute bottom-16 md:bottom-24`}>RATING 5.0 ON CLUTCH</button>
             </div>
         </div>
    </div>
  )
